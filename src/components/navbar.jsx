        ...
        <nav className='bg-white border-gray-200 dark:bg-gray-900 w-full fixed' >
            <div className='max-x-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 mx-16'>
                ...
                < ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700" >
                    <li>
                        <a href="/about" class="group text-black transition duration-300 hover:text-gray-400">
                            about
                            <span class="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-black m-auto"></span>
                        </a>
                    </li>
                    <li>
                        <a href="/worknexperience" class="group text-black transition duration-300 hover:text-gray-400">
                            Work/experience
                            <span class="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-black m-auto"></span>
                        </a>
                    </li>
                    <li className='relative flex justify-center items-center '>
                        ...
                        '>
                            <p className='px-2 group text-black transition duration-300 hover:text-gray-400'>contact
                                <span class="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-black m-auto"></span>
                            </p>
                            ...
                            <div className='absolute hidden group-focus:block top-full min-w-full w-max bg-white shadow-md mt-1 rounded transition'>
                                <ul className='text-left border rounded'>
                                    <li className='px-4 py-1 hover:bg-gray-100 border-b'>
                                        <a href='https://github.com/Purrrgrammer' target="_blank">
                                            github:purrgrammer
                                        </a>
                                    </li>
                                    <li className='px-4 py-1 hover:bg-gray-100 border-b'>
                                        <a href='https://www.linkedin.com/in/woramjvic/' target="_blank">
                                            lkn:woramjvic
                                        </a>
                                    </li>
                                    <li className='px-4 py-1 hover:bg-gray-100 border-b'>woram.j.vic@gmail.com</li>
                                    <li className='px-4 py-1 hover:bg-gray-100 border-b'>
                                        +66 806495969
                                    </li>
                                </ul>
